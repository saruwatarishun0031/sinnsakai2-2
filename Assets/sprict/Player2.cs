...
public class Player2 : MonoBehaviour
{
    ...
    Slider _pointSlider;
    [SerializeField, Tooltip("Player2スピード")]
    int Speed;
    ...
    void Attke()
    {
        if (Input.GetButtonDown("shooting 2") && NumberOfBullets >= 1 && Interval <= 0)
        {
    ...
    public void Death()
    {
        gameObject.GetComponent<Player2>().enabled = false;//動いて欲しくない
